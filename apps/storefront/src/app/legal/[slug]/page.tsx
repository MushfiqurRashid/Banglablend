...
import { getLegalPage } from "@/lib/content/queries";
...
export default async function LegalPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return <StandardPage eyebrow="Legal preview" title={title} introduction="This page is intentionally excluded from search until qualified legal and operational reviewers approve it in the content workspace."><div className="verification-notice"><p>No policy text is published from code. Add the reviewed policy, effective date and approval record in the admin content workspace to make this route indexable.</p></div></StandardPage>;
}
